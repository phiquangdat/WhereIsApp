        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <View style={styles.iconContainer}>
                    <TouchableOpacity onPress={() => navigation.navigate('RecordEdit', { note: note })}>
            ...
            <View style={styles.content}>
                ...
                {note?.image && (
                    <View>
                        ...
                        <Image source={{ uri: 'file://' + note.image }} style={styles.image} />
                    </View>
                )}
                {note?.location && (
                    <Text style={styles.location}>📍 {note.location.latitude}, {note.location.longitude}</Text>
                )}
            </View>
        </View>
    );
...
const styles = StyleSheet.create({
    ...
    location: { fontSize: 14, color: '#555', textAlign: 'center', marginBottom: 20 }
});
